...
/* PJ107 PIR proximity configuration console Giovanni Blu Mitolo 2020
 This is a basic example to show how PJ107 can be used practically.
 The Serial monitor is used to configure and print data from PJ107 */
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println("PJ107 PIR proximity sensor configuration console - Giovanni Blu Mitolo 2020");
  print_help();
};
...
void error_handler(uint8_t code, uint8_t data) {
  if(code == PJON_CONNECTION_LOST) {
    Serial.print("Connection lost - PJ107 ID ");
...
void print_help() {
  Serial.println();
  Serial.println("Use the Serial console input field to configure the PJ107 module.");
  Serial.println("Input commands guide: ");
  Serial.println("?!        -> Help and device info");
  Serial.println("E!        -> Request a PIR proximity reading");
  ...
  if(Serial.available() > 0) {
    ...
    if(req_byte == '!') {
      ...
      if((char)packet[0] == 'I') {
        ...
        Serial.print("Setting PJ107 device id: ");
      ...
      if((char)packet[0] == 'Q') {
        ...
        Serial.println("Flash the PJ107 module with PJ107.ino to unblock!");
